...
const ShopFeatures = () => {
  const features = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M9 9h6" />
        </svg>
      ),
      title: "Free Shipping",
  ...
  return (
    <section className="py-16 px-6 lg:px-16 bg-[#F9F1E7]">
